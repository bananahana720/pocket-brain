    ...
    if ((this as any).state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 p-8 max-w-sm w-full text-center shadow-sm">
            ...
            <h3 className="text-base font-semibold text-zinc-800 dark:text-zinc-100 mb-2">Something went wrong</h3>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6">An unexpected error occurred. Your data is safe.</p>
            <button
